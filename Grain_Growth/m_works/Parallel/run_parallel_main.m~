...
processi=1; % processor ID number
mkdir(savedir)
...
mboxsize=800; % system grid numbers in x direction
nboxsize=800; % system grid numbers in y direction
delx=2;       % Delta x
