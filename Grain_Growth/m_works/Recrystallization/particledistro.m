...
%% For band distribution of particles
if strcmp(distribution,'band')
yparticle=[fix(nboxsize/2-1/10*nboxsize)*ones(1,particles_number) fix(nboxsize/2+1/10*nboxsize)*ones(1,particles_number)];
xparticle=fix(mboxsize*rand(1,2*particles_number))+1;
end 
