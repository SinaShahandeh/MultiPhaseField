...
movie2avi(M,'C:\My docs\Projects\Phase Transformation\Phase Field Model\Grain Growth\works\uniform.avi')


%% Animation
clear
dirstring='c:\PF_Data\test_guillaume\no_band\';
% dirstring='/Drive2/sim_res/Particles1/results';
% dirstring='/Drive2/sim_res/Particles2/dissolve1460/'
...
ni=0;
i=1;
Mtn=[1:2:100 105:5:1000 1020:20:4000 4050:50:10000 10100:100:20000 20200:200:40000];
% Mtn=[10000:2:10100 10100:100:20000 20200:200:40000];
% Mtn=[1480]
for tn=Mtn
    filename=strcat(dirstring,'no_band',num2str(tn),'.mat');
    load(filename)
...
clear
dirstring='c:\PF_Data\test_guillaume\no_band\';
load(strcat(dirstring,'final','.mat'))
figure
plot(Timehistory(1:length(fraction)),fraction)
...
JMAKf=log(log(1./(1-f)));
JMAKf(JMAKf==inf)=[];
t=Timehistory(1:length(JMAKf));
plot(log(t(10:end)),JMAKf(10:end),'ro')
pp=polyfit(log(t(10:end)),JMAKf(10:end),1)
hold on
ezplot(poly2sym(pp),[log(t(10)) log(t(end))])

%% SUBPLOT figures
clear
dirstring='/Drive2/sim_res/Particles1/Dissolve800/'
dirstring='/Drive2/sim_res/non_uniform_par1/'
dirstring='/Drive2/sim_res/set5'
...
save(strcat(dirstring,'/','Grains_','.mat'))
...
figure
bar(Adist,n.*exp(Adist)/sum(n.*exp(Adist)))
...
%% for plot
clear
dirstring='/media/disk/sim_res/set3/';
load(strcat(dirstring,'setings','.mat'))
