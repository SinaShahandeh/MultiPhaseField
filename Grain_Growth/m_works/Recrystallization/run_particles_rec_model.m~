...
clear
savedir='/media/disk/sim_res/Rec_1/';
...
for npi=2:p
etapf=nucleidistro(nboxsize,mboxsize,fix(nuclein/(p-1)),6,'uniform');
eta(:,:,npi)=etapf;
eta(:,:,1)=eta(:,:,1).*imcomplement(etapf);
end
