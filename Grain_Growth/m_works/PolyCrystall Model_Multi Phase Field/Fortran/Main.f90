C This is Multi Phase Field simulation for normal grain growth in 2D [1,2].
C The particle pinning based on Molean's functional [3] is also included.
C
C  References:
C 1. L-Q Chen, W. Yang, Phys. Rev. B, 1994, 50; 15752.
C 2. D. Fan, L. Q. Chen, Acta Mater. 1997, 45; 611.
C 3. N. Moelans, B. Blanpain, P. Wollants, Acta Mater. 2005, 54;1175.
C


savedir="test"
C choose whether save or not
saveresults=1
C time steps that save command is executed
n=0
for ni=1,100
  n=n+1
  savetimesteps(n)=ni
...
[1:100 105:5:1000 1020:20:4000 4050:50:10000];
mkdir(savedir)
figure;
% clf
...
mboxsize=100; % system grid numbers in x direction
nboxsize=100; % system grid numbers in y direction
delx=2;       % Delta x
