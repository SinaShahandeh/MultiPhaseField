function Sigma=realtime_1D_particle_interface_func(epsilon)
savedir='vsssss';
mkdir(savedir)
...
scale=10;
mboxsize=8*scale; % y axis in pixels
nboxsize=0.3*scale; % x axis
...
eta(:,:,1)=zeros(mboxsize,nboxsize)+1;
